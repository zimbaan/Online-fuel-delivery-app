...
const MOCKDATA = [
  { title: "Email", description: "deliverysystem@gmail.com", icon: At },
  { title: "Phone", description: "+91987654321", icon: Phone },
  { title: "Address", description: "COIMBATORE", icon: MapPin },
